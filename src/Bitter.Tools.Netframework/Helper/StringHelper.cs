...
namespace Bitter.Tools.Helper
{
    public class StringHelper
    {
        ...
        public static string Decode(string str)
        {
            if (!string.IsNullOrEmpty(str))
            {
                try
                {
                    ...
                    return HttpUtility.UrlDecode(DecodeBase64(Encoding.UTF8.GetString(stream.ToArray())));
                }
        ...
        /// <param name="Encoding">解码编码：UTF-8 GB2312</param>
        /// <returns></returns>
        public static string UrlDecodeString(string Str, string Encoding)
        {
        ...
        /// <param name="Encoding">转化编码：UTF-8 GB2312</param>
        /// <returns></returns>
        public static string UrlEncodeString(string Str, string Encoding)
        {
            return System.Web.HttpUtility.UrlEncode(Str, System.Text.Encoding.GetEncoding(Encoding)); ;
        }
